    ...
    <div className="flex flex-col items-center w-20 sm:w-24 shrink-0">
      <div className="relative">
        ...
        <div className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br ${gradient} ring-4 ring-white shadow-xl flex flex-col items-center justify-center text-white`}>
          ...
          <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-wide">{label}</span>
        </div>
      </div>
      <p className="text-xs sm:text-sm font-bold text-navy-900 text-center mt-2 leading-tight">{sublabel}</p>
    </div>
  )
}
...
export default function SalesPagePlanoMoney() {
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      {/* Trust bar */}
      <div className="bg-gradient-to-r from-lila-600 via-accent-600 to-celeste-600 text-white text-center py-3.5 px-4 text-base sm:text-lg font-bold flex items-center justify-center gap-2 sm:gap-5 flex-wrap">
      ...
      <section className="relative bg-gradient-to-b from-lila-50 via-celeste-50/40 to-white pt-10 pb-6 px-4 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-5">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-navy-900 leading-tight">
          ...
          <a
            href={CHECKOUT_URL}
            className="inline-block bg-gradient-to-r from-lila-500 via-accent-600 to-celeste-500 hover:brightness-110 text-white font-bold py-4 px-9 rounded-full text-lg shadow-xl shadow-accent-600/30 transition hover:scale-105"
          >
            Empezar ahora →
          </a>
        </div>
      ...
      <section className="max-w-2xl mx-auto px-4 pt-4 pb-14 text-center">
        <h2 className="text-3xl sm:text-4xl font-black text-navy-900">Estás a un paso de transformar tus finanzas</h2>
        <p className="text-slate-500 text-base sm:text-lg max-w-lg mx-auto mt-2 mb-6">
      ...
      <section className="bg-gradient-to-br from-celeste-50 via-white to-lila-50 py-14 px-4">
        <div className="max-w-2xl mx-auto space-y-8">
          <h2 className="text-3xl sm:text-4xl font-black text-navy-900 text-center">¿Qué vas a lograr con Plano.Money?</h2>
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-5">
            {BENEFITS.map((b, i) => (
              <div key={b} className="flex items-start gap-3">
                <span className={`w-2.5 h-2.5 rounded-full mt-2.5 shrink-0 ${DOT_COLORS[i % DOT_COLORS.length]}`} />
                <p className="text-base sm:text-lg text-slate-700">{b}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto space-y-8">
          <h2 className="text-3xl sm:text-4xl font-black text-navy-900 text-center">Gente real, resultados reales</h2>
      ...
      <section className="bg-gradient-to-br from-brand-50 via-white to-celeste-50 py-14 px-4">
        <div className="max-w-xl mx-auto space-y-6">
          <h2 className="text-3xl sm:text-4xl font-black text-navy-900 text-center">Tu compra incluye</h2>
      ...
      <section className="py-14 px-4 relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto space-y-6">
          ...
          <div className="relative bg-navy-900 rounded-2xl p-7 sm:p-8 text-center space-y-4 overflow-hidden">
            ...
            <p className="relative text-white/70 text-sm font-bold uppercase">Empezá hoy</p>
            <p className="relative text-lg font-semibold text-white/40 line-through">US$ 12.99/mes</p>
            <p className="relative text-4xl sm:text-5xl font-black text-white">US$ 5.99<span className="text-xl font-semibold text-white/60">/mes</span></p>
            <p className="relative text-white/40 text-sm line-through">US$ 155.99/año</p>
            <p className="relative text-white/60 text-sm">o US$ 35.99/año (equivale a menos de US$ 3/mes)</p>
            <a
              href={CHECKOUT_URL}
              className="relative block w-full bg-gradient-to-r from-lila-400 via-white to-celeste-300 text-navy-900 font-bold py-4 rounded-xl text-lg hover:brightness-105 transition"
            >
              Empezar ahora →
            </a>
            <p className="relative text-white/50 text-sm">🎁 En el siguiente paso vas a poder sumar contenido extra con descuento especial.</p>
            <div className="relative flex items-center justify-center gap-4 text-white/50 text-sm pt-1">
      ...
      <footer className="max-w-2xl mx-auto px-4 pb-10 text-center space-y-2">
        ...
        <p className="text-sm text-slate-300">© {new Date().getFullYear()} Novi Global International S.A. · Plano.Money — Todos los derechos reservados.</p>
      </footer>
    </div>
  )
}
